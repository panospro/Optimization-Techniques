% In this script there are the plots for the Bisection Method with the use
% of derivatives. There are 4 figures created:
...
for i = 1:3
    ...
    for l = linspace(0.001,0.1,50)
        [~,~,iter(k),lamda(k)] = bisectionMethodWD(F{i},l,a,b);
        k = k + 1;
    end
    subplot(3,1,i)
...
for k = 1:3
    ...
    for i = 1:length(l)
        ...
        [a_i,b_i,iter,~] = bisectionMethodWD(F{k},l(i),a,b);
